...
Labels differ from the example clients: wrappers in scope, disposal required, set-up fee, risk band. A label allowlist will keep some fields and drop others.
