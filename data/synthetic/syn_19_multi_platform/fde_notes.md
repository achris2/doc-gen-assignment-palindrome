...
Three platforms, a practice sale in three money kinds, a stale joint GIA, a child's account out of scope, and a new joint account that does not exist on the snapshot yet.
