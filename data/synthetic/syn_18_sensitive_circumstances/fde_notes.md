...
Inheritance after a bereavement. The background should mention the origin with care and must not invent a tax figure. This is a different household from any example client.
