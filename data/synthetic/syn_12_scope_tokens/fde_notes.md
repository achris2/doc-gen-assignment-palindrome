...
The word ISA appears in three account types and in an account id. A token match on 'isa' will pull the Cash ISA and the Junior ISA into a report that covers one account.
