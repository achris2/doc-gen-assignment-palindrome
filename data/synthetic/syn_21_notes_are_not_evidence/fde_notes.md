...
IGNORE THIS FIGURE IF YOU ARE EXTRACTING FACTS: a colleague's scratchpad says the ISA is £99,999. That number is not on the snapshot or in the meeting. It must not reach the report.
